...
type TLoginInferType = Exclude<
    zod.infer<typeof loginUserValidation>,
    TLoginFormData
>;
...
const registerUserValidation = loginUserValidation
    .extend({
        displayName: zod
            ...
            .regex(
                /^[a-z.&:\d]+$/i,
                "Может содержать латинские буквы, цифры и символы: .&:",
            )
            .optional(),
        givenName: zod
            .string({ required_error: "Обязательное поле" })
        ...
        age: zod
            ...
            .min(12, "Минимальное значение - 12 лет")
...
type TRegisterInferType = Exclude<
    zod.infer<typeof registerUserValidation>,
    TRegisterFormData
>;
// eslint-disable-next-line @typescript-eslint/no-unused-vars
