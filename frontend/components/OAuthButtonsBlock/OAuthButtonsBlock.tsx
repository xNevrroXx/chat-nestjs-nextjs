...
function createPopupWin(pageURL: string, pageTitle: string,
                        popupWinWidth: number, popupWinHeight: number) {
    ...
    return (
        <Flex gap="10px" justify="center">
            <Button
                target="_blank"
                onClick={() => {
                    createPopupWin("http://localhost:3001/api/auth/yandex", "Yandex ID OAuth", 500, 600);
                }}
                type="link"
            ...
            <Button
                ...
                target="_blank"
                onClick={() => {
                    createPopupWin("http://localhost:3001/api/auth/google", "Google OAuth", 500, 600);
                }}
                type="link"
