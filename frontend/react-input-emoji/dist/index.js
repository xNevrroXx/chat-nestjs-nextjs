...
function EmojiPickerButton(_ref) {
  ...
  var _useState = React.useState( /** @type {"OWN" | "REF" | "CUSTOM_CONTENT" | "IDLE"} */"IDLE"),
    _useState2 = _slicedToArray(_useState, 2),
    typeButton = _useState2[0],
    setTypeButton = _useState2[1];
  ...
  }, [buttonRef, buttonElement, buttonElement === null || buttonElement === void 0 ? void 0 : buttonElement.childNodes, toggleShowPicker]);
  return typeButton !== "IDLE" && typeButton !== "REF" && /*#__PURE__*/React__default["default"].createElement("button", {
    ref: localButtonRef,
    type: "button",
    className: "react-input-emoji--button".concat(showPicker ? " react-input-emoji--button__show" : ""),
    onClick: toggleShowPicker
  }, typeButton === "OWN" && /*#__PURE__*/React__default["default"].createElement("svg", {
...
function EmojiPicker(props) {
  ...
  React.useEffect(function () {
    if (!language) {
      ...
      // @ts-ignore
      fetch("".concat(EMOJI_MART_DATA_URL, "/i18n/en.json")).then( /*#__PURE__*/function () {
    ...
    // @ts-ignore
    fetch("".concat(EMOJI_MART_DATA_URL, "/i18n/").concat(language, ".json")).then( /*#__PURE__*/function () {
...
var EmojiPickerWrapper = function EmojiPickerWrapper(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(EmojiPickerContainer, {
    set: set,
